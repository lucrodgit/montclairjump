...
class Obstacle:
    ...
    def draw(self, screen):
        if self.type == "ground":
            pygame.draw.rect(screen, self.color, (self.x, self.y, self.IMG_W, self.IMG_H))
            pygame.draw.rect(screen, WHITE, (self.x, self.y, self.IMG_W, self.IMG_H), 2)
        else:
            pygame.draw.ellipse(screen, self.color, (self.x, self.y, self.IMG_W, self.IMG_H))
            pygame.draw.ellipse(screen, WHITE, (self.x, self.y, self.IMG_W, self.IMG_H), 2)
